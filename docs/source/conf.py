...
project = 'asynctb'
copyright = 'The asynctb authors'
author = 'The asynctb authors'
...
latex_documents = [
    (master_doc, 'asynctb.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'asynctb', 'asynctb Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'asynctb', 'asynctb Documentation',
     author, 'asynctb', 'Traceback utilities for async programming in Python',
     'Miscellaneous'),
]
